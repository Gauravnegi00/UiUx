...
const ClientHome = ({ onClose }) => {
  return (
    <div className="fixed z-101 inset-0 w-full h-screen flex items-center justify-center shadow-lg overflow-hidden">
      <div className="w-1/2 h-screen bg-[rgba(101,89,89,0.76)] flex flex-col gap-2 justify-center items-center">
        <div className="w-[70%] relative h-[400px] flex">
          <img src={logo} alt="Logo" loading="lazy" className="w-[200px] h-[300px]" />
          <span className="mt-52 text-[50px] font-extrabold font-serif">yrixCraft</span>
      ...
      <div className="w-1/2 h-screen font-serif bg-[rgba(109,98,98,0.76)] p-5">
        <div className="relative">
          <FaTimes
            onClick={onClose}
            className="absolute right-10 bg-[#c2baba3d] h-12 w-12 flex justify-center items-center rounded-full hover:scale-[1.1] hover:cursor-pointer hover:bg-black hover:text-white transition-all duration-500 ease-in-out"
            size={30}
          />
          <h2 className="text-5xl">Let's get in touch</h2>
          <img src={downArrow} loading="lazy" alt="Down Arrow" className="w-[150px] ml-[-55px]" />
          ...
          <div className="w-full mt-5">
            ...
            <div className="w-full mt-5">
              <input type="text" placeholder="Ansh from zyrixcraft" className="bg-[#b8a4a45d] p-5 border-none rounded-2xl" />
              <input type="text" placeholder="ansh@gmail.com" className="ml-5 bg-[#b8a4a45d] p-5 border-none rounded-2xl" />
            </div>
